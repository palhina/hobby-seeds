...
- [ ] FadeIn コンポーネント
  - [ ] 画面表示時のフェードイン
  - [ ] duration, delay プロパティ
- [ ] SlideIn コンポーネント
  - [ ] 下からスライドイン
  - [ ] direction プロパティ（上/下/左/右）
- [ ] ScalePress コンポーネント
  - [ ] タップ時の縮小アニメーション
  - [ ] ハプティックフィードバック連携
...
- [ ] FadeIn, SlideIn, ScalePress が実装されている
- [ ] ProgressAnimation が診断画面で動作する
- [ ] カードのタップアニメーションが動作する
- [ ] ハプティックフィードバックが連携している
- [ ] パフォーマンスに問題がない（useNativeDriver使用）
