...
### 診断フロー設計
- [ ] 質問内容の確定
  - [ ] Q1: 今のエネルギーレベルは？（low/medium/high）
  - [ ] Q2: 外に出たい気分？（はい/いいえ）
  - [ ] Q3: 何かを作りたい or 眺めていたい？（active/passive）
- [ ] 回答データ構造の確認（DiagnosisAnswer型）
